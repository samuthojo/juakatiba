        ...
        <div class="layout">
            ...
            <div id="content" class="flex">
                <div id="pageTitle">
                    ...
                    {{--<p>--}}
                        {{--Please browse through the questions below to see if yours is included. <br>--}}
                        {{--Otherwise give us call us on: <strong>+255718438719</strong>--}}
                        {{--or send as email at: <strong>info@juakatibatanzania.com</strong>--}}
                    {{--</p>--}}
                    <h1>Una Maswali? Tazama hapa.</h1>
                    <p>
                        Tafadhali angalia maswali na majibu yaliyoorodheshwa kuona kama swali lako limejibiwa au la.<br>
                        <span id="mawasiliano">
                            Kwa maelezo zaidi, simu: <strong>+255718438719</strong>&nbsp; au &nbsp;
                            barua pepe: <strong>info@juakatibatanzania.com</strong>
                        </span>
                    </p>
                </div>
                <div class="faq">
