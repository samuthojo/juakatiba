...
<div class="row">
    <div class="col-lg-6 col-xs-6">
        <div class="register-box-body" style="color: #000000;">
            <p style="font-size: large;" class="login-box-msg">REKEBISHA MDAHALO</p>
            <form name="edit_form" id="edit_form">
                <input type="hidden" name="edit_id" id="edit_id" value="{{ $midahalo['id'] }}"/>
                <div class="form-group has-feedback">
                    <select id="type" name="type">
                        <option value="swahili" {{ $midahalo['type']=='swahili'?'selected="selected"':'' }} >Swahili</option>
                        <option value="english" {{ $midahalo['type']=='english'?'selected="selected"':'' }} >English</option>
                    </select>
                </div>
                <div class="form-group has-feedback">
                    <input style="color: #000000;" type="text" class="form-control" name="date" id="date" placeholder="Tarehe" value="{{ $midahalo['date'] }}">
                    <span class="glyphicon glyphicon-calendar form-control-feedback"></span>
                </div>
                <div id="resultText" contenteditable="true" style="min-height: 100px; min-width: 100px; border: 1px solid;">{{ $midahalo['description'] }}</div>
                <div class="btn-group">
                ...
                <div class="row">
                    <div class="col-xs-4 pull-right">
                        <button type="button" class="btn btn-success btn-block btn-flat" onclick="save_changes('midahalo')">save</button>
                    </div>
