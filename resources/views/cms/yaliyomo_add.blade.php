...
<div class="row">
    <div class="col-lg-10 col-xs-10">
        <div class="register-box-body" style="color: #000000;">
            <p style="font-size: large;" class="login-box-msg">ONGEZA YALIYOMO NA UTANGULIZI</p>
            <form name="add_form" id="add_form">
                ...
                <div class="form-group has-feedback">
                    <select id="context" name="context">
                        <option value="yaliyomo">Yaliyomo</option>
                        <option value="utangulizi">Utangulizi</option>
                    </select>
                </div>
                <div class="form-group has-feedback">
                    <select id="katiba" name="katiba">
                        <option value="katiba77">Katiba 1977</option>
                ...
                <div class="row">
                    <div class="col-xs-4 pull-right">
                        <button type="button" class="btn btn-success btn-block btn-flat" onclick="form_save('yaliyomo')">save</button>
                    </div>
