<style>
    ...
    .owl-carousel .owl-wrapper-outer .item .slide-image {
    ...
    .middle-nav .mid-logo-nav a div{
        width: 80%;
        height: 100%;
        background: url("{{url('assets/images/logo3.png')}}");
        /*background-size: 80%;*/
    ...
    .bottom-social h1:before{
        content: "PEKUA ZAIDI KUTOKA KWENYE MITANDAO YA KIJAMII";
    }
    .bottom-social span{
        text-align: right;
        color: #ffffff;
...
<section class="ipf-slideshow">
    <div id="owl-demo" class="owl-carousel slide-show">
        ...
        <div class="item">
            <div class="slide-image" style="background-image: url('{{url('assets/images/bunge2.jpg')}}')">

            </div>

        </div>
        <div class="item">
            <div class="slide-image" style="background-image: url('{{url('assets/images/slidesample4.jpg')}}')">
                    ...
                    @foreach($news as $details)
                        ...
                        <div>
                            ...
                            <div class="news-contents">
                                ...
                                <span class="summary">{!! substr($details['description'],0,200) !!}<a href="{{$details['link']}}" style="color: blue; cursor: pointer;" target="_blank">&nbsp;...read more</a></span>
                            </div>
                        </div>
                    @endforeach
                @endif
        ...
        <div class="bottom-nav">
            ...
            <div class="bottom-social">
               ...
               <div>
                   <h1></h1>
                <span>
                   <a href="https://www.facebook.com/juakatibatz" target="_blank"> <i class="fa fa-facebook-square" ></i></a>&nbsp;
                   <a href="https://twitter.com/JuaKatibaTz" target="_blank"> <i class="fa fa-twitter-square"></i></a>&nbsp;
                   <a href="https://www.instagram.com/juakatibatz/" target="_blank"> <i class="fa fa-instagram"></i></a>&nbsp;
                   <a href="https://www.youtube.com/channel/UCeiaGpyu62Sqt3l9Tys2Ikg" target="_blank"> <i class="fa fa-youtube"></i></a>
